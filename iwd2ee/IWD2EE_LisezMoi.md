# Icewind Dale 2: Enhanced Edition (IWD2EE)
...
1. [Noyau d’IWD2EE](#1-noyau-diw2dee)
...
5. [Dons de prédilection pour toutes les écoles de magie](#5-dons-de-prédilection-pour-toutes-les-écoles-de-magie)
6. Remaniement des objets
7. Remaniement des créatures(difficulté+)
...
12. L'Oeil du Dragon plus rapide
13. Raccourcir la série de quêtes de la boucle temporelle de l'Oeil du Dragon à une seule bataille
14. Ajouter plus de parchemins au jeu
15. Résistances et immunités des créatures revues à la baisse
16. Changer l’immunité aux coups critiques
17. Meilleurs ennemis raciaux pour les rôdeurs
18. Débloque tous les choix de couleur pour chaque race
19. Plus d’options de persuasion
20. Composant principale des compagnons
21. Les compagnons commencent avec de l’expérience en rejoignant le groupe
22. Améliorations cosmétiques de l’interface graphique et nouveaux écrans de chargement (incomplet)
23. Thème principal en boucle
24. Champ de Bataille du Temple de Glace remanié
25. Résistance mineure aux dégâts pour les armures et les boucliers
26. Remaniement des races
27. Les ennemis donnent la même quantité d’expérience quel que soit le niveau du groupe
28. Ajuster le niveau des rencontres (difficulté++)
29. Réduire les bonus aux PV des créatures en mode Cour de Furie
30. Réduire les bonus à l’attaque des créatures en mode Cour de Furie
31. Réduire les bonus aux jets de sauvegarde des créatures en mode Cour de Furie
32. Supprimer les bonus de valeurs de caractéristiques des créatures alliées invoquées en mode Cour de furie
33. Faire en sorte que le groupe commence le jeu avec plus d’expérience en mode Cour de Furie
34. Réduire le délai entre chaque attaque sournoise
35. Ajuster le niveau maximum
36. Toujours apprendre avec succès les sorts provenant de parchemins
37. Ajouter les attaques d’opportunité au jeu
...
40. Ajouter des raccourcis clavier pour automatiser l’application de buffs
...
* IWD2EE inclut la compatibilité avec les moniteurs modernes, rendant le Widescreen Mod inutile. N'INSTALLEZ PAS LE WIDESCREEN MOD AVEC IWD2EE ; CELA FERA PLANTER LE JEU. Lorsque vous démarrez IWD2EE, un menu s’ouvre vous permettant de régler le jeu à une résolution plus élevée. Notez que les paramètres de résolution plus élevées n'ont pas d'influence sur les menus ; ils n'en ont que lorsque vous chargez une partie sauvegardée. Je conseille personnellement une résolution d'une hauteur de 600pou 768p pour que l'interface en jeu prenne toute la hauteur de votre écran et pour garder du texte un minimum lisible. Pour les écrans 21:9 et autres ultrawide, vous pouvez appliquer une résolution adaptée (comme 1835*768 ou 1433*600) dans le fichier ddraw.ini à la section [iwd2].
...
* Il est possible de déplacer la caméra avec le bouton centrale de la souris.
...
* Si vous n’avez pas activé l’option pour se reposer jusqu’à être guéri, les personnages guérissent un nombre de PV égal à leur niveau, au lieu de ne guérir qu’un seul PV.
...
Bardes : les chants de barde devraient être plus utiles maintenant. Ils sont également répartis sur plus de niveaux et évoluent au fil des niveaux afin que les bardes n’atteignent plus leur apogée au niveau 11. Les chansons peuvent se cumuler, mais uniquement si plusieurs bardes chantent en même temps.
...
Druides : les druides bénéficient d'un nouvel ensemble de formes dans lesquels ils peuvent se métamorphoser. Les capacités de chaque forme varient en fonction du niveau du druide.
...
--Restrictions d’alignement plus souples pour les classes--
...
--Dons de prédilection pour toutes les écoles de magie--
...
- En mode Coeur de Furie, les ennemis sont plus forts de diverses manières. Les capacités innées des monstres ont des DD de jets de sauvegarde plus élevés et/ou infligent plus de dégâts. Les lanceurs de sorts lancent des sorts de niveau supérieur à ceux qu'ils lancent dans les modes de difficulté normaux.
...
- En mode Coeur de Furie, les moines ennemis ont des poings de moine de niveau supérieur pour refléter le fait qu'ils sont de niveau supérieur.
- En mode Coeur de Furie, les créatures invoquées par les ennemis gagnent désormais des bonus de Coeur de Furie.

--Meilleure progression des PX--
...
--Alternative plus intéressante aux quêtes de la Palissade--
...
--Ajouter des moyens supplémentaires de progresser dans certaines zones--
...
--Raccourcir la quête de la boucle temporelle de l’Œil du Dragon à une seule bataille--
...
--Ajouter plus de parchemins au jeu--

Ce composant ajoute des parchemins de mage de niveau relativement élevé à divers vendeurs de sorts, dont Elytharra, Zack Boosenburry, Suoma, Bered et Sheemish. Un magicien solo ou un magicien en mode Coeur de Furie pourra apprendre des sorts haut de gamme et suivre le rythme d’un ensorceleur. Ce n’est pas trop extrême : les vendeurs en début de partie peuvent avoir un ou deux parchemins de niveau 5 à 7, mais ils n’auront pas des tonnes de parchemins de niveau 9.

--Immunités des créatures révisées--
...
--Jets de sauvegarde plus précis pour les ennemis--
...
--Réviser l’immunité aux coups critiques--
...
--Meilleurs ennemis raciaux pour les rôdeurs--
...
--Les PNJ commencent avec de l’expérience en rejoignant le groupe pour correspondre à l’expérience du groupe--
...
--Résistance aux dégâts mineure pour les armures et les boucliers--
...
--Les ennemis donnent la même quantité d'expérience quel que soit le niveau du groupe--
...
--Ajuster la mise à l’échelle du niveau des rencontres--
...
--Réduire les bonus de PV des créatures en mode Cœur de Furie--
...
--Réduire les bonus d’attaque des ennemis en mode Cœur de Furie--
...
--Réduire les bonus de jets de sauvegarde des créatures en mode Cœur de Furie--

Au début du mode Coeur de Furie, il peut être très difficile de faire échouer les jets de sauvegarde des ennemis si vous commencez avec un groupe de bas niveau. Ce composant donne un petit malus de jets de sauvegarde aux créatures en dehors du groupe en mode Cœur de Furie.

--Supprimer les bonus de caractéristiques des créatures alliées invoquées en mode Cœur de Furie--

En mode Cœur de Furie, les créatures alliées invoquées obtiennent également des bonus du mode Coeur de Furie, et comme vous atteignez un niveau élevé plus rapidement, les créatures invoquées peuvent être assez surpuissantes. Ce composant fait en sorte que les créatures invoquées ne gagnent pas les +10 habituels à toutes les caractéristiques que les créatures obtiennent en mode Cœur de Furie (à l'exception de +10 en Constitution, ce qui devrait au moins en faire des sacs à PV décents), à moins qu'elles ne soient invoquées par un ennemi.

--Faire en sorte que le groupe commence avec plus d’expérience en mode Cœur de Furie--
...
--Réduire le délai après une attaque sournoise avant que la créature ne puisse être attaquée à nouveau--
...
--Toujours apprendre les sorts des parchemins avec succès--

Ce composant permet à tous les magiciens d’apprendre avec succès les sorts des parchemins 100 % du temps.

--Tout le monde peut effectuer des attaques d’opportunité--
...
--Changer la façon dont les valeurs de caractéristiques sont attribuées à la création du personnage--
...
--Ajouter des raccourcis clavier pour automatiser les buffs--
...
Quelques objets Coeur de Furie en mode normal :
